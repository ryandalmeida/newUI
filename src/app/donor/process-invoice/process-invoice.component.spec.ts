...
describe('ProcessInvoiceComponent', () => {
  ...
  it('should test cancelInvoiceSearch()', () => {
    component.cancelInvoiceSearch();
  });
  ...
  it('should test dashboard table', (done) => {
    ...
    fixture.whenStable().then(() => {
      ...
      expect(headerRow.childNodes[3].innerText).toEqual("Ar Id")
      expect(headerRow.childNodes[4].innerText).toEqual("Fund Type")
      expect(headerRow.childNodes[5].innerText).toEqual("Invoice Id")
