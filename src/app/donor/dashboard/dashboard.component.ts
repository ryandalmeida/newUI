...
export class DashboardComponent implements OnInit {
  ...
  dataSource: MatTableDataSource<PledgeData> = null;
  ...
  ngOnInit() {
    this.registerForm = this.formBuilder.group({
      ...
      installments: ['', [Validators.required, ValidationService.numberOnlyValidator]],
    });
    ...
    this.updateForm = this.formBuilder.group({
      ...
      startDate: [''],
      endDate: [''],
      amount: ['',  [ ValidationService.numberOnlyValidator]],
      paymentPeriod: ['',  ValidationService.numberOnlyValidator],
      installments: ['', [ ValidationService.numberOnlyValidator]],
      pledgeId: ['']
    });
  ...
  onSubmit() {
    ...
    this.pledgeService.submitPledge(submitPledgeData).subscribe(response => {
       if (response.toString().includes("Pledge ID")) {
        var dialogData = {
