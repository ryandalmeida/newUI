...
export class PledgeService {
  ...
  searchPledgeApprover(myPostObject) {
    return this.http.post<any>('https://wbg-bpm-apim.azure-api.net/pledge-api/pledge/searchApprover', myPostObject, { headers: new HttpHeaders().set('Azure-Auth', 'true') })
  }
