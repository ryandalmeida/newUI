...
export class MatchPaymentService {
    ...
    completed(myPostObject) {
        return this.http.post<any>('https://5ufe1v6q92.execute-api.us-east-1.amazonaws.com/test/processpayment-submitmatchpayment ', myPostObject, { headers: new HttpHeaders().set('aws-auth', 'true') })
    }
