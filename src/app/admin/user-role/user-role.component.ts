...
export class UserRoleComponent implements OnInit {
  ...
  searchUserName() {
    ...
    var response = {
      "userId": 2,
      "emailId": "nlnu2@worldbankgroup.org",
      "userName": "wb550673",
      "firstName": "Neema",
      "lastName": "Mohandas",
      "role": [
      ...
      this.fname = response.firstName.charAt(0).toUpperCase()+ response.firstName.substr(1).toLowerCase();
      this.lname = response.lastName.charAt(0).toUpperCase()+ response.lastName.substr(1).toLowerCase();
