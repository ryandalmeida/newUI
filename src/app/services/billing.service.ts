...
export class BillingService {
  ...
  getAllAR(): Observable<Billing[]> {
    ...
    return this.http.get<Billing[]>('https://swdgufpck8.execute-api.us-west-2.amazonaws.com/test/accountreceivable-getactivear', { headers: new HttpHeaders().set('aws-auth', 'true') });
