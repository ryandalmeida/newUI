...
export class BillingService {
  ...
  submitBill(submitObject): Observable<Object> {
    return this.http.post('https://5ufe1v6q92.execute-api.us-east-1.amazonaws.com/test/tasktokenpoller', submitObject, { headers: new HttpHeaders().set('aws-auth', 'true') });
  }
}