...
export class DashboardComponent implements OnInit {
  ...
  constructor(private pledgeService: PledgeService, private formBuilder: FormBuilder, public dialog: MatDialog, private pagerService: PagerService, private changeDetectorRefs: ChangeDetectorRef,
              private spinnerService: Ng4LoadingSpinnerService, private sortService: SortService, private errorDialogService: ErrorDialogService, private MsAdalSvc: MsAdalAngular6Service) { }
    ...
    this.pledgeService.submitPledge(submitPledgeData).subscribe(response => {
      ...
      if (response === "SUCCESS") {
        var dialogData = {
          ...
          "data": " Pledge created successfully."
        }
      }
      if (response === "FAILURE") {
        var dialogData = {
