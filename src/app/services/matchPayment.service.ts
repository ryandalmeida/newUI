...
export class MatchPaymentService {
    ...
    searchMatchPaymentService(postObject) {
        ...
        //'http://internal-ea-paas-backend-alb-738279272.us-east-1.elb.amazonaws.com/processPayment/searchMatchPayment'
    ...
    getAllMatchPayments(): Observable<PaymentData[]> {
        ...
        //'http://internal-ea-paas-backend-alb-738279272.us-east-1.elb.amazonaws.com/processPayment/viewProcessPayment'
