...
export const environment = {
  ...
  accountReceivableServiceURL: 'http://wbgeabpmservicesaws.worldbankgroup.org',
  billingServiceURL:'https://wbgeabpmservicesaws.worldbankgroup.org',
  processInvoiceServiceURL : 'https://wbgeabpmservicesaws.worldbankgroup.org',
  processPaymentServiceURL: 'http://wbgeabpmservicesaws.worldbankgroup.org',
  matchPaymentServiceURL: 'http://wbgeabpmservicesaws.worldbankgroup.org',
